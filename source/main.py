...
def web_page():
    ...
    <body>
        ...
        <table>
            ...
            <tr><td>Teplota</td><td><span class="sensor">""" + str(bmp.temperature) + """ °C</span></td></tr>
            <tr><td>Atm. tlak</td><td><span class="sensor">""" + str(round(bmp.pressure)) + """ hPa</span></td></tr>
            <tr><td>Nadm. výška</td><td><span class="sensor">""" + str(round(bmp.altitude)) + """ m</span></td></tr>
        </table> 
    </body>
</html>"""
    return html
